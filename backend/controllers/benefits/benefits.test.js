...
describe('Benefits Controller', () => {
    ...
    test('getBenefitByInvoiceId should return benefits', async () => {
        ...
        pool.query.mockResolvedValue([[{ id: 1, object: 'Health Insurance', unit: 12, price_per_unit: 100 }]]);

        await benefitsController.getBenefitByInvoiceId(req, res);

        expect(res.json).toHaveBeenCalledWith([{ id: 1, object: 'Health Insurance', unit: 12, price_per_unit: 100 }]);
    });
